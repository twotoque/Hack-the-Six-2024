          ...
          <form class="max-w-md mx-auto ml-0 mt-3 mb-3">
            ...
            <div class="relative">
              ...
              <input
                type="search"
                id="default-search"
                class="block w-full p-4 ps-10 border-white text-sm text-gray-900 border rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500 "
                placeholder="What are you feeling?"
                required
              />
              <button
                type="submit"
                class="absolute end-2.5 bottom-2.5 bg-background-orange focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Search
              </button>
            </div>
